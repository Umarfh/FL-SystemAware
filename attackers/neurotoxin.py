...
@attacker_registry.register("Neurotoxin", ["data_poisoning", "model_poisoning"], "attacker")
...
class Neurotoxin(MPBase, DPBase, Client):
    ...
    def __init__(self, *args, num_sample=64, topk_ratio=0.1, norm_threshold=0.2, attack_model="all2one", poisoning_ratio=0.32, target_label=6, source_label=1, attack_strategy="continuous", single_epoch=0, poison_frequency=5, **kwargs):
        ...
        self.default_attack_params = {
            'num_sample': num_sample, 'topk_ratio': topk_ratio, 'norm_threshold': norm_threshold, "attack_model": attack_model, "poisoning_ratio": poisoning_ratio, "target_label": target_label, "source_label": source_label, "attack_strategy": attack_strategy, "single_epoch": single_epoch, "poison_frequency": poison_frequency}

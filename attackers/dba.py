...
@attacker_registry.register("DBA", ["data_poisoning"], "attacker")
...
class DBA(DPBase, Client):
    ...
    def __init__(self, *args, attack_model="all2one", scaling_factor=100, trigger_factor=[8, 2, 0], poisoning_ratio=0.32, source_label=2, target_label=7, attack_strategy="continuous", single_epoch=0, poison_frequency=5, attack_start_epoch=None, **kwargs):
        super().__init__(*args, **kwargs)
        self.default_attack_params = {"attack_model": attack_model, "scaling_factor": scaling_factor, "trigger_factor": trigger_factor, "poisoning_ratio": poisoning_ratio, "source_label": source_label, "target_label": target_label, "attack_strategy": attack_strategy, "single_epoch": single_epoch, "poison_frequency": poison_frequency, "attack_start_epoch": attack_start_epoch}

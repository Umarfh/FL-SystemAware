...
@attacker_registry.register("AlterMin", ["data_poisoning", "model_poisoning"], "attacker")
class AlterMin(MPBase, DPBase, Client):
    ...
    def __init__(self, *args, attack_model="targeted", source_label=3, target_label=7, poisoned_sample_cnt=1, boosting_factor=10, rho=1e-4, benign_epochs=10, malicous_epochs=1, **kwargs):
        ...
        """
        self.default_attack_params = {"attack_model": attack_model, "source_label": source_label, "target_label": target_label, "poisoned_sample_cnt": poisoned_sample_cnt,
                                      "boosting_factor": boosting_factor, "rho": rho, "benign_epochs": benign_epochs, "malicous_epochs": malicous_epochs}

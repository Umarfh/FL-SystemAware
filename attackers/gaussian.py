...
@attacker_registry.register("Gaussian", ["model_poisoning", "non_omniscient"], "attacker")
...
class Gaussian(MPBase, Client):
    ...
    def __init__(self, *args, noise_mean=0, noise_std=1, **kwargs):
        super().__init__(*args, **kwargs)
        self.default_attack_params = {'noise_mean': noise_mean, 'noise_std': noise_std}

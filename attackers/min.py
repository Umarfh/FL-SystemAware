...
class MinBase(MPBase, Client):
    ...
    def __init__(self, *args, gamma_init=10.0, stop_threshold=1e-5, **kwargs):
        super().__init__(*args, **kwargs)
        self.default_attack_params = {
            'gamma_init': gamma_init, 'stop_threshold': stop_threshold}
...
@attacker_registry.register("MinMax", ["model_poisoning", "omniscient"], "attacker")
...
@attacker_registry.register("MinSum", ["model_poisoning", "omniscient"], "attacker")
@actor('attacker', 'model_poisoning', 'omniscient')

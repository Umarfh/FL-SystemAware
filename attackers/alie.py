...
@attacker_registry.register("ALIE", ["model_poisoning", "omniscient"], "attacker")
class ALIE(MPBase, Client):
    ...
    def __init__(self, *args, z_max=None, attack_start_epoch=None, **kwargs):
        super().__init__(*args, **kwargs)
        self.default_attack_params = {
            'z_max': z_max, "attack_start_epoch": attack_start_epoch}

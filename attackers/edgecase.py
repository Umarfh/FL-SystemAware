...
@attacker_registry.register("EdgeCase", ["data_poisoning", "model_poisoning", "non_omniscient"], "attacker")
...
class EdgeCase(MPBase, DPBase, Client):
    ...
    def __init__(self, *args, poisoning_ratio=0.8, epsilon=0.25, PGD_attack=True, projection_type="l_2", l2_proj_frequency=1, scaling_attack=True, scaling_factor=50, target_label=1, **kwargs):
        ...
        self.default_attack_params = {
            "poisoning_ratio": poisoning_ratio, "epsilon": epsilon, "PGD_attack": PGD_attack, "projection_type": projection_type, "l2_proj_frequency": l2_proj_frequency, "scaling_attack": scaling_attack, "scaling_factor": scaling_factor, "target_label": target_label}

...
@attacker_registry.register("FangAttack", ["omniscient"], "attacker")
...
class FangAttack(MPBase, Client):
    ...
    def __init__(self, *args, stop_threshold=1.0e-5, **kwargs):
        super().__init__(*args, **kwargs)
        self.default_attack_params = {'stop_threshold': stop_threshold}

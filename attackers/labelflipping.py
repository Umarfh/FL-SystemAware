...
@attacker_registry.register("LabelFlipping", ["data_poisoning"], "attacker")
...
class LabelFlipping(DPBase, Client):
    ...
    def __init__(self, *args, attack_model='targeted', source_label=2, target_label=7, attack_strategy="continuous", single_epoch=0, poison_frequency=5, poisoning_ratio=0.32, **kwargs):
        ...
        self.default_attack_params = {
            'attack_model': attack_model, 'source_label': source_label, 'target_label': target_label, "attack_strategy": attack_strategy, "single_epoch": single_epoch, "poison_frequency": poison_frequency, "poisoning_ratio": poisoning_ratio}

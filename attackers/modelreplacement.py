...
@attacker_registry.register("ModelReplacement", ["data_poisoning", "model_poisoning", "non_omniscient"], "attacker")
...
class ModelReplacement(MPBase, DPBase, Client):
    ...
    def __init__(self, *args, scaling_factor=50, alpha=0.5, attack_model="all2one", poisoning_ratio=0.32, target_label=6, source_label=3, attack_strategy="continuous", single_epoch=0, poison_frequency=5, **kwargs):
        ...
        self.default_attack_params = {
            'scaling_factor': scaling_factor, "alpha": alpha, "attack_model": attack_model,

...
@attacker_registry.register("IPM", ["model_poisoning", "omniscient"], "attacker")
...
class IPM(MPBase, Client):
    ...
    def __init__(self, *args, scaling_factor=0.1, attack_start_epoch=None, **kwargs):
        super().__init__(*args, **kwargs)
        # scale=0.1, 0.5, 1, 2, 100 all break FedAvg and GeometricMedian, small scale, such a 0.1, breaks Krum
        self.default_attack_params = {
            'scaling_factor': scaling_factor, "attack_start_epoch": attack_start_epoch}

...
@model_registry.register("lenet", ["model"], "model")
class lenet(nn.Module):
    def __init__(self, num_channels=1, num_classes=10):
        super().__init__()
        self.conv1 = nn.Conv2d(num_channels, 6, 5)
        self.conv2 = nn.Conv2d(6, 16, 5)
        # Corrected input size for fc1 based on MNIST input (1x28x28)
        # After conv1 (28-5+1=24), pool (24/2=12) -> (6, 12, 12)
        # After conv2 (12-5+1=8), pool (8/2=4) -> (16, 4, 4)
...
@model_registry.register("lenet_bn", ["model"], "model")
